...
func TestArgumentValidationRejectsBadInput(t *testing.T) {
	...
	cases := []struct {
		...
		{"symbol body negative context", `{"jsonrpc":"2.0","id":4,"method":"tools/call","params":{"name":"show","arguments":{"qualified_name":"fmt.Println","source":true,"context_lines":-5}}}`, "context_lines must be between 0 and 500"},
		...
		{"unknown edge_type", `{"jsonrpc":"2.0","id":10,"method":"tools/call","params":{"name":"all_edges","arguments":{"edge_type":"bogus"}}}`, "edge_type must be one of"},
		{"unknown search mode", `{"jsonrpc":"2.0","id":15,"method":"tools/call","params":{"name":"search","arguments":{"pattern":"x","mode":"regex"}}}`, "mode must be one of"},
